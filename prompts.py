...
# https://github.com/Nick-is-building/AI-Tool-Compliance-Assistant-DE
#
# Kein Rechtsgutachten. Ersetzt keine Fachberatung. 
...
Aufgabe:
1. Datenverarbeitung, Serverstandort, Subprozessoren
2. Mögliche Mitarbeiterdaten und Monitoring-Funktionen
3. Technische Sicherheit: Verschlüsselung (At Rest / In Transit),
   Authentifizierung (SSO/MFA), Zertifizierungen (ISO 27001, SOC 2), Logging
4. Strukturierte Faktenbasis für Prompt 2 – inklusive Quellenangaben
"""
